...
func run() error {
	...
	resolverPortInt, err := strconv.Atoi(resolverPort)
	dnsResolver.AddUpstream(resolverDomain, net.ParseIP(resolverIp), resolverPortInt, resolverDomain)
